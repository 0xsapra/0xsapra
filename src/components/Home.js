	...
	if (isMobile) {
		return (
			<ul className="list-group list-group-flush bg-transparent social-landing-mobile" id="social-landing-mobile">
				<li className="list-group-item bg-transparent glow"><a target="_blank" rel="noreferrer" href="https://www.linkedin.com/in/aman-sapra-6363b0138/"><i className="fab fa-linkedin" aria-hidden="true"></i> LinkedIn</a></li>
		...
		return (
			<ul className="list-inline social-landing" id="social-landing-desktop">
				<li className="list-inline-item glow"><a target="_blank" rel="noreferrer" href="https://www.linkedin.com/in/aman-sapra-6363b0138/"><i className="fab fa-linkedin" aria-hidden="true"></i><p className="hidden my-2">LinkedIn</p></a></li>
